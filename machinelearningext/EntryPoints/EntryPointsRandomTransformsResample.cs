...
namespace Scikit.ML.EntryPoints
{
    ...
    public static class EntryPointResample
    {
        ...
        public static CommonOutputs.TransformOutput Resample(IHostEnvironment env, ResampleTransform.ArgumentsEntryPoint input)
        {
    ...
    public static class EntryPointsResampleHelper
    {
        ...
        {
            exp.AddSerialize(EntryPointsConstants.EntryPointPrefix + EP_Resample.Name, input, output);
        }
    }
